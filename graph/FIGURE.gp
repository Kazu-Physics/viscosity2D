...
FNS(x)=sqrt(0.28**2+B*0.75*log(x/(2*sqrt(2))))
B=1/(8*pi)
fit [10:] FNS(x) "../data/viscosity.txt" u 1:3:4 yerror via B

p FNS(x) lc black lw 3 dt (12,8) notitle,\
...
set terminal pdfcairo enhanced font "Times-New-Roman,25" color size 16cm,12cm
set key font "Times-New-Roman, 20"
set border lw 1.5

set lmargin at screen 0.21689
set rmargin at screen 0.74724
set bmargin at screen 0.21041
set tmargin at screen 0.84531

unset colorbox
set colorbox vertical user origin 0.72461,0.21188 size 0.02208,0.6349

set output "Sinf_heatmap.pdf"
set size ratio -1
...
set xrange [-pi-dx/2:pi+dx/2]
set yrange [-pi-dy/2:pi+dy/2]

set link x2 via x inverse x
set link y2 via y inverse y

plot "../data/LxLy128_harmonic_temp1.0_0.75_periodic/Sinf_angulardep.txt" u 1:2:(dx/2):(dy/2):3 w boxxy palette
